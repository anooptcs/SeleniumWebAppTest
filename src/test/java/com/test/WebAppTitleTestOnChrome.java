...
public class WebAppTitleTestOnChrome {
	...
	public static String appURL = "http://18.191.248.129:8080/DevOpsWebApp-1.0.0-SNAPSHOT/training.html";
	...
	public void testGooglePageTitleInChrome() throws Exception{
		driver.navigate().to("http://18.191.248.129:8080/DevOpsWebApp-1.0.0-SNAPSHOT/training.html");
